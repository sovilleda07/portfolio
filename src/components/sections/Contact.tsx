export function Contact() {
  return (
    <section id="contact" className="mb-20 w-full max-w-250 py-20">
          ...
          <div className="flex flex-1 flex-col justify-between gap-8">
            <div>
              ...
              <p className="mb-8 leading-relaxed text-slate-600 dark:text-slate-300">
                ...
                clean, scalable, and user-focused web applications, feel free to
                reach out.
              </p>
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <span className="font-medium">sovilleda07@gmail.com</span>
                </a>
          ...
          <div className="flex-1">
            <form className="flex flex-col gap-4">
              <div className="space-y-1">
                <label className="ml-3 text-xs font-bold uppercase text-slate-500">
                  Name
                </label>
                <input
                  type="text"
